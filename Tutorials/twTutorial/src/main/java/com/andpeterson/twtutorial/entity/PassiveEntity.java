...
public class PassiveEntity extends AnimalEntity {
	...
	protected PassiveEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
		super(type, worldIn);
	}
	
	@Override
	public AgeableEntity createChild(AgeableEntity ageable) {
		PassiveEntity entity = new PassiveEntity(ModEntityTypes.PASSIVE_ENTITY.get(), this.world);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 1.1D, Ingredient.fromItems(ItemInit.EXAMPLE_FOOD.get()), false));
